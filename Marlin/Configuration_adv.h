 ...
 */
#define E0_AUTO_FAN_PIN FAN1_PIN // mnul - default: -1 - for hotend-fan to turn on > 50°C
...
#define HOMING_BUMP_MM      { 0, 0, 2 }       // mnul - default { 5, 5, 2 } - for sensorless homing - (mm) Backoff from endstops after first bump
...
//
#define ASSISTED_TRAMMING  // mnul
#if ENABLED(ASSISTED_TRAMMING)

  // Define positions for probe points.
  #define TRAMMING_POINT_XY { {  20, 20 }, { 165,  20 }, { 165, 165 }, { 20, 165 } }  // mnul
...
#define DISABLE_INACTIVE_Z true  // mnul - default: false - Set 'false' if the nozzle could fall onto your printed part!
...
//#define LCD_BACKLIGHT_TIMEOUT 30 // (s) Timeout before turning off the backlight
  ...
  #define PROBE_OFFSET_WIZARD       // mnul - Add a Probe Z Offset calibration option to the LCD menu
     ...
     */
    #define PROBE_OFFSET_WIZARD_START_Z -4.0  // mnul
    ...
    //#define X_AXIS_TWIST_COMPENSATION  // mnul - turn off due to EEPROM bug
  ...
  #define PREHEAT_SHORTCUT_MENU_ITEM // mnul
  ...
  #define STATUS_MESSAGE_SCROLLING // mnul
...
// LCD Print Progress options
    ...
    #define SHOW_REMAINING_TIME         // mnul - Display estimated time to completion
    #if ENABLED(SHOW_REMAINING_TIME)
      //#define USE_M73_REMAINING_TIME    // Use remaining time from M73 command instead of estimation
      #define ROTATE_PROGRESS_DISPLAY   // mnul - Display (P)rogress, (E)lapsed, and (R)emaining time
    #endif
  #endif
   ...
   * point in the file.
   */
  #define POWER_LOSS_RECOVERY  // mnul
  #if ENABLED(POWER_LOSS_RECOVERY)
    #define PLR_ENABLED_DEFAULT   true // mnul - default: false - Power Loss Recovery enabled by default. (Set with 'M413 Sn' & M500)
  ...
  #define UTF_FILENAME_SUPPORT  // mnul

  #define LONG_FILENAME_HOST_SUPPORT    // mnul - Get the long filename of a file/folder with 'M33 <dosname>' and list long filenames with 'M20 L'
  //#define LONG_FILENAME_WRITE_SUPPORT   // Create / delete files with long filenames via M28, M30, and Binary Transfer Protocol

  #define SCROLL_LONG_FILENAMES         // mnul - Scroll long filenames in the SD card menu
   ...
   */
  #define CONFIGURATION_EMBEDDING  // mnul
   ...
   */
  #define SDCARD_CONNECTION ONBOARD  // mnul
 ...
 */
  ...
  #define STATUS_ALT_BED_BITMAP       // mnul - Use the alternative bed bitmap
  #define STATUS_ALT_FAN_BITMAP       // mnul - Use the alternative fan bitmap
 ...
 */
#define BABYSTEPPING  // mnul
#if ENABLED(BABYSTEPPING)
  //#define INTEGRATED_BABYSTEPPING         // EXPERIMENTAL integration of babystepping into the Stepper ISR
  //#define BABYSTEP_WITHOUT_HOMING
  //#define BABYSTEP_ALWAYS_AVAILABLE         // mnul - Allow babystepping at all times (not just during movement).
  //#define BABYSTEP_XY                     // Also enable X/Y Babystepping. Not supported on DELTA!
  #define BABYSTEP_INVERT_Z false           // Change if Z babysteps should go the other way
  //#define BABYSTEP_MILLIMETER_UNITS       // Specify BABYSTEP_MULTIPLICATOR_(XY|Z) in mm instead of micro-steps
  #define BABYSTEP_MULTIPLICATOR_Z  4       // mnul - (steps or mm) Steps or millimeter distance for each Z babystep
  #define BABYSTEP_MULTIPLICATOR_XY 4       // mnul - (steps or mm) Steps or millimeter distance for each XY babystep

  #define DOUBLECLICK_FOR_Z_BABYSTEPPING    // Double-click on the Status Screen for Z Babystepping.
  #if ENABLED(DOUBLECLICK_FOR_Z_BABYSTEPPING)
    #define DOUBLECLICK_MAX_INTERVAL 1250   // Maximum interval between clicks, in milliseconds.
                                            // Note: Extra time may be added to mitigate controller latency.
    #define MOVE_Z_WHEN_IDLE                // mnul - Jump to the move Z menu on doubleclick when printer is idle.
    #if ENABLED(MOVE_Z_WHEN_IDLE)
      #define MOVE_Z_IDLE_MULTIPLICATOR 1   // Multiply 1mm by this factor for the move step size.
    #endif
  #endif

  #define BABYSTEP_DISPLAY_TOTAL            // mnul - Display total babysteps since last G28

  #define BABYSTEP_ZPROBE_OFFSET            // mnul - Combine M851 Z and Babystepping
 ...
 */
#define LIN_ADVANCE  // mnul
#if ENABLED(LIN_ADVANCE)
  //#define EXTRA_LIN_ADVANCE_K // Enable for second linear advance constants
  #define LIN_ADVANCE_K 0.1    // mnul - Unit: mm compression per 1mm/s extruder speed
  //#define LA_DEBUG            // If enabled, this will generate debug information output over USB.
  #define EXPERIMENTAL_SCURVE // mnul - Enable this option to permit S-Curve Acceleration
  #define ALLOW_LOW_EJERK     // mnul - Allow a DEFAULT_EJERK value of <10. Recommended for direct drive hotends.
#endif
 ...
 */
#define FWRETRACT  // mnul
#if ENABLED(FWRETRACT)
  #define FWRETRACT_AUTORETRACT             // Override slicer retractions
  #if ENABLED(FWRETRACT_AUTORETRACT)
    #define MIN_AUTORETRACT             0.1 // (mm) Don't convert E moves under this length
    #define MAX_AUTORETRACT            2.0 // mnul - (mm) Don't convert E moves over this length
  #endif
  #define RETRACT_LENGTH                0.4   // mnul - (mm) Default retract length (positive value)
  #define RETRACT_LENGTH_SWAP          13   // (mm) Default swap retract length (positive value)
  #define RETRACT_FEEDRATE             25   // mnul - (mm/s) Default feedrate for retracting
 ...
 */
#define ADVANCED_PAUSE_FEATURE // mnul
  ...
  #define PARK_HEAD_ON_PAUSE                      // mnul - Park the nozzle during pause and filament change.
  //#define HOME_BEFORE_FILAMENT_CHANGE           // If needed, home before parking for filament change

  #define FILAMENT_LOAD_UNLOAD_GCODES             // mnul - Add M701/M702 Load/Unload G-codes, plus Load/Unload in the LCD Prepare menu.
 ...
 */
   ...
   */
  #define CHOPPER_TIMING CHOPPER_DEFAULT_24V        // mnul - All axes (override below)
   ...
   */
  #define MONITOR_DRIVER_STATUS // mnul
   ...
   */
//  #define SENSORLESS_HOMING // mnul - StallGuard capable drivers only
...
#define MEATPACK_ON_SERIAL_PORT_1  // mnul
#define MEATPACK_ON_SERIAL_PORT_2  // mnul

#define GCODE_CASE_INSENSITIVE  // mnul - Accept G-code sent to the firmware in lowercase
